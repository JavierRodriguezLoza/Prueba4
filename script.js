...
function configurarFiltros(filtroTipo, filtroColor, filtroPrecio, valorPrecio, btnLimpiarFiltros, gridElement) {
    // Actualizar opciones del filtro tipo en español
    const filtroTipoElement = document.getElementById('filtro-tipo');
    if (filtroTipoElement) {
        filtroTipoElement.innerHTML = `
            <option value="todos">Todos los tipos</option>
            <option value="splendens">Betta Splendens</option>
            <option value="halfmoon">Media Luna</option>
            <option value="crowntail">Corona</option>
            <option value="plakat">Plakat</option>
            <option value="doubletail">Doble Cola</option>
