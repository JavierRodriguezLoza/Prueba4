...
const productos = [
    { id: 1, tipo: "splendens", color: "Rojo", precio: 1500, imagen: "1.jpeg" },
    { id: 2, tipo: "halfmoon", color: "Azul", precio: 1800, imagen: "2.jpeg" },
    { id: 3, tipo: "crowntail", color: "Turquesa", precio: 1200, imagen: "3.jpeg" },
    { id: 4, tipo: "plakat", color: "Acero", precio: 1000, imagen: "4.jpeg" },
    { id: 5, tipo: "doubletail", color: "Opaco", precio: 2000, imagen: "5.jpeg" },
    { id: 6, tipo: "dumbo", color: "Negro", precio: 1600, imagen: "6.jpeg" },
    { id: 7, tipo: "splendens", color: "Naranja", precio: 1400, imagen: "7.jpeg" },
...
// Utilidades - Formateador de precio sin decimales
    ...
    ` : productosArray.map(producto => `
        <div class="producto-card">
            ...
            <div class="producto-info">
                ...
                <p class="producto-precio">${formateadorPrecio(producto.precio)} CUP</p>
...
function configurarFiltros() {
    ...
    elementos.filtroPrecio.addEventListener('input', () => {
        ...
        elementos.valorPrecio.textContent = valor === 2000 ? 'Cualquier precio' : `Hasta ${formateadorPrecio(valor)} CUP`;
        aplicarFiltros();
    });
...
function contactarPorProducto(tipo, color, precio) {
    const mensaje = `Hola, estoy interesado en el Betta ${tipo} de color ${color} (${formateadorPrecio(precio)} CUP). ¿Podrían darme más información?`;
